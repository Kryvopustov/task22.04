$("document").ready(function() { 
	...
	var myModule = (function (){	
		...
		function createTable(tempData, country, city){
			...
			var i = 0;
			table.empty();
			table.append("<thead><tr><th>Date</th><th>Country</th><th>City</th><th>Temp</th><th>Pressure</th><th>Wind speed</th><th>Weather</th></tr></thead>");			
			for (i; i < 3; i++) {
				table.append("<tr><td>"+tempData[i].dt_txt+"</td><td>"+country+"</td><td>"+city+"</td><td>"+kelvinToCelsius(tempData[i].main.temp)+"\u00B0C</td><td>"+tempData[i].main.pressure+" hpa</td><td>"+tempData[i].wind.speed+" m/s</td><td>"+tempData[i].weather[0].description+"</td></tr>");
			}
		};
